...
var authMiddleware = createMiddleware(async (c, next) => {
  ...
  try {
    ...
    const message2 = error instanceof Error ? error.message : "JWT verification failed";
    return c.json(
      {
        error: message2,
        code: "UNAUTHORIZED"
...
// .wrangler/tmp/bundle-lhN2cP/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-lhN2cP/middleware-loader.entry.ts
